...
peaks: find_peaks pos_to_peak peak_parameters peak_profile tidal_tensor_profile tidal_tensor_peaks tidal_tensor_all
...
tidal_tensor_all: ./src/tidal_tensor_all.c
	mpicc $(FFTW_INCL) $(FFTW_LIBS) -lfftw3f_mpi -lm -o ./bin/tidal_tensor_all ./src/tidal_tensor_all.c
